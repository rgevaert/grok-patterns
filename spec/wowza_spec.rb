...
describe "the wowza access/stats log grok pattern" do
  ...
  describe "wowza access log line" do
    ...
    it "should have the correct date value" do
      @match.should have_logstash_field("date").with_value("2016-05-17")
    end

    it "should have the correct time value" do
      @match.should have_logstash_field("time").with_value("08:45:56")
    end
    ...
    it "should have the correct csBytes value" do
      @match.should have_logstash_field("csBytes:float").with_value("3431")
    end

    it "should have the correct scBytes value" do
      @match.should have_logstash_field("scBytes:float").with_value("3073")
    end
    ...
    it "should have the correct csStreamBytes value" do
      @match.should have_logstash_field("csStreamBytes:float").with_value("-")
    end

    it "should have the correct scStreamBytes value" do
      @match.should have_logstash_field("scStreamBytes:float").with_value("-")
    end
    ...
    it "should have the correct xFileSize value" do
      @match.should have_logstash_field("xFileSize:float").with_value("-")
    end
